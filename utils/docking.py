...
#         # for linux smina.static
#         command = (
#             f'{path}/smina.osx.12 -r {path}/{docking_target}/prot.pdb '
...
# def get_kras_score(smi: str, verbose: bool = False):
#     if apply_filters(smi) == True and lipinski_filter( smi ) == True:
#         score = get_score(smi=smi, docking_target='kras', verbose=verbose) # '4lde', '6y2f', '1syh'
#         return score # MINUS SIGN FOR OPTIMIZATION!
#     else:
#         return 10**4
